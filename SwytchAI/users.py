...
ROLES = {
    "technician": {
        "level": 1,
        "description": "Network Install Technician",
        "permissions": [
            "pull_config",
            "view_versions",
            "compare_configs",
    ...
    "admin": {
        "level": 4,
        "description": "SwytchAI Administrator",
        "permissions": [
            "pull_config",
            "view_versions",
            "compare_configs",
...
def hash_password(password):
    ...
    This means the actual password is never stored — only the hash.
    Even if someone opens the file, they can't see the real password.
    """
